...
/* BASE */
	...
	$('.menu-responsive .menu-link, .responsive-logo').click(function(event) {
		cerrar_nav();
	});
...
/* --- FIN BASE --- */
	...
	function cambio_pantalla2(){
		var alto_pantalla2 = $(window).height()-75; 
		var ancho_pantalla2 = $(window).width();

		if (ancho_pantalla2 > 943) {
			$('.alto-bg2').height(alto_pantalla2);
		}else{
			$('.alto-bg2').css('height', 'auto');
		};
	};
